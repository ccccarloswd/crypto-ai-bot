    ...
    for simbolo in CRIPTOS:
        ...
        if n_longs > 0:
            ...
            if sub_long:
                ...
                # IA corto plazo: solo informativo, no afecta al score (ver TODO en score_predictivo_long)
        ...
        if n_shorts > 0:
            ...
            if sub_short:
                ...
                # IA corto plazo: solo informativo, no afecta al score (ver TODO en score_predictivo_short)
