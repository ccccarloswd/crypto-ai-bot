...
SCORE_NIVEL4    = 9.0   # score ≥ este valor → nivel4 (x30 lev)
SCORE_NIVEL3    = 6.0   # score ≥ este valor → nivel3 (x20 lev)
SCORE_NIVEL2    = 4.0   # score ≥ este valor → nivel2 (x12 lev)
...
# Un indicador débil en contra NO penaliza — solo los fuertes lo hacen.
# Esto evita que stoch/vol/rsi en zona media bloqueen operaciones válidas.
FUERZA_MIN_PENALIZACION = 0.8   # fuerza < este valor → el indicador contrario no penaliza
FACTOR_PENALIZACION     = 0.5   # fuerza ≥ umbral → penaliza solo al 50% de su fuerza
...
def score_minimo(prob: float, direccion: str) -> int:
    return 3  # nivel1 opera con score ≥ 3 (poco capital, x4 apalancamiento)
