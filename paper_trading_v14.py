...
def abrir_posicion(estado: Dict, simbolo: str, precio: float, atr: float,
    ...
    # Inyectamos macd_hist_prev desde el DataFrame real porque la columna no existe
    # como tal en el Series de última fila — sin esto el MACD siempre puntúa 0.
    ...
    pts_calidad, notas_calidad = calcular_calidad_score(
        ultima_cal, ctx4h or {}, divs or {}, dir_
    )
