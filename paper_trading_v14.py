...
def score_predictivo_short(df: pd.DataFrame, ultima: pd.Series,
                            ctx4h: Dict, patrones: Dict = None) -> Tuple[int, List[str]]:
    """
    ...
    for simbolo in CRIPTOS:
        ...
        if n_longs == 0:
            ...
            if sub_long:
                ...
                score_l, razones_l = score_predictivo_long(df_pred, ultima, ctx4h, patrones)
        ...
        if n_shorts == 0 and len(estado['posiciones']) < MAX_POSICIONES:
            ...
            if max_g_long < 0.03:
                ...
                if sub_short:
                    ...
                    score_s, razones_s = score_predictivo_short(df_pred, ultima, ctx4h, patrones)
